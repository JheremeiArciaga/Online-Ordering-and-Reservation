   ...
   <div class="banner-area breadcrumb-area padding-top-120 padding-bottom-90">
    ...
    <div class="portfolio-info shopping-cart padding-top-120 padding-bottom-90">
        <div class="shopping-shapes">
            <span class="ps1"><img src="<?php echo base_url(); ?>assets/img/shapes/12.png" alt=""></span>
            <span class="pss2 item-bounce"><img src="<?php echo base_url(); ?>assets/img/shapes/26.png" alt=""></span>
            <span class="ps3 item-bounce"><img src="<?php echo base_url(); ?>assets/img/hapes/7.png" alt=""></span>
            <span class="ps4"><img src="<?php echo base_url(); ?>assets/img/img/32.png" alt=""></span>
            <span class="pss5"><img src="<?php echo base_url(); ?>assets/img/shapes/16.png" alt=""></span>
            <span class="ps6"><img src="<?php echo base_url(); ?>assets/img/shapes/13.png" alt=""></span>
        </div>
        <div class="container">
            <form action="#">
                <!-- upper table -->
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class=" d-none d-md-block col-md-4">
                                                <div class="table-img"><img src="<?php echo base_url(); ?>assets/img/<?php echo $cData->i_image;?>" alt="">
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-12 col-md-8">
                                                <h5><?php echo $cData->i_name;?></h5>
                                            </div>
                                        </div>
                                    </td>
                                    <td><?php echo number_format($cData->i_price,2);?></td>
                                    <!--data-th="Price"-->
                                    <td>
                                        <!-- data-th="Quantity"-->
                                        <input type="number" class="form-control text-center" value="<?php echo $cData->mnu_qty;?>">
                                    </td>
                                    <td class="text-center"><?php echo number_format($cData->i_price * $cData->mnu_qty, 2);?></td>
                                    <!--data-th="Subtotal"  -->
                                    <td>
                                        <!--class="actions" data-th=""-->
                                        <span class="remove"><a href="<?php echo base_url(); ?>home/removeitem/<?php echo $this->session->web_session;?>/<?php echo $cData->mnu_no;?>"><i class="fas fa-plus"></i></a></span>
                                    </td>
                                </tr>
                        ...
                        <div class="lower-table">
                            ...
                            <div class="lower-table-info">
                                ...
                                <ul class="d-flex justify-content-between">
                                 ...
                                 <?php if($total > 0 ) { ?>
                                    <a href="<?php echo base_url(); ?>home/checkout/" class="btn" style="width:100%; margin-top:20px">Proceed to checkout</a>
                                <?php } else { ?>
                                    <a href="#" class="btn" style="width:100%; margin-top:20px">Proceed to checkout</a>
                                <?php }?>
