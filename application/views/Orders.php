                                ...
                                if($ol_Data){
                                    foreach ($ol_Data as $rs) { if($rs->order_status == 0) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php if ($rs->order_status ==0){echo 'Order Recieved';} else if($rs->order_status ==1){echo 'Order Processed';} else {echo 'Order Delivered';}?></td>
                                            <th>
                                                <a href="<?php echo base_url();?>home/order_listing/<?php echo $rs->reference_num;?>"><i class="fa fa-eye"></i> view order</a>
                                            </th>
                                        </tr>
                                    <?php } } } ?>
                                </tbody>
