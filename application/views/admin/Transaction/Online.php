        ...
        <div class="right_col" role="main">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Online Orders <small> New Orders </small></h2>
                        ...
                        <div class="x_content">
                            ...
                            <table id="datatable" class="table table-striped table-bordered table-hover table-fixed">
                                ...
                                <?php
                                if($ol_Data){
                                    foreach ($ol_Data as $rs) { if($rs->order_status == 0) {
                                        ?>
                                        <tr>
                                            ...
                                            <th>
                                                ...
                                                <br>
                                                <a href="<?php echo base_url();?>admin/order_update/<?php echo $rs->reference_num;?>/1"><i class="fa fa-check"></i> process</a>
                                                <br>
