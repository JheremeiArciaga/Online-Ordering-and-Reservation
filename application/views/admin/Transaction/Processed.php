        ...
        <div class="right_col" role="main">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Online Orders <small> Processed Orders </small></h2>
                        ...
                        <div class="x_content">
                            ...
                            <table id="datatable" class="table table-striped table-bordered table-hover table-fixed">
                                ...
                                <?php
                                if($ol_Data){
                                    foreach ($ol_Data as $rs) { if($rs->order_status == 1) {
                                        ?>
                                        <tr>
                                            <td><?php echo $rs->reference_num;?></td>
                                            <td><?php echo $rs->order_datetime;?></td>
                                            <td><?php echo $rs->first_name;?> <?php echo $rs->last_name;?></td>
                                            <td><?php echo $rs->complete_address;?></td>
                                            <td><?php echo $rs->nearest_landmark;?></td>
                                            <td><?php echo $rs->email_add;?></td>
                                            <td><?php echo $rs->contact_num;?></td>
                                            <td><?php echo $rs->order_notes;?></td>
                                            <th>
                                                <a href="<?php echo base_url();?>admin/order_listing/<?php echo $rs->reference_num;?>"><i class="fa fa-eye"></i> view</a>
                                                <br>
                                                <a href="<?php echo base_url();?>admin/order_update/<?php echo $rs->reference_num;?>/2"><i class="fa fa-check"></i> deliver</a>
                                                <br>
