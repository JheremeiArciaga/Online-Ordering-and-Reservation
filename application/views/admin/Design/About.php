        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" >
                    <a href="#" class="site_title"> <span class="text-center">Aischi Grill House</span></a>
                </div>
        ...
        <div class="right_col" role="main">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Design <small>About Us</small></h2>

                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                            <br />
                            <form id="story-form" method="post" action="<?php echo base_url();?>admin/a_about_update" data-toggle="validator"  class="form-horizontal form-label-left" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    foreach ($a_Data as $a_Row){
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-12 col-sm-12 col-xs-12">History :
                                                </label>
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <textarea required="required" id="a_history" name="a_history" class="form-control" rows="6" placeholder='' ><?php echo $a_Row->a_history; ?></textarea>
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="col-md-12 col-sm-12 col-xs-12">Mission :
                                                </label>
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <textarea required="required" id="a_mission" name="a_mission" class="form-control" rows="6" placeholder='' ><?php echo $a_Row->a_mission; ?></textarea>
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="col-md-12 col-sm-12 col-xs-12">Vision :
                                                </label>
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <textarea required="required" id="a_vision" name="a_vision" class="form-control" rows="6" placeholder='' ><?php echo $a_Row->a_vision; ?></textarea>
                                                </div>
                                            </div>


                                            <div class="form-group">
                                                <label class="col-md-12 col-sm-12 col-xs-12">Image File :
                                                </label>
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <input type="file" class="form-control" accept="image/*" id="file" name="Filename" onchange="return fileValidation()"/>
                                                </div>
                                            </div>
                                        </div>

                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <img id="story-pic" class="img-responsive avatar-view" style="height:90vh; width:100vw;" src="<?php echo base_url();?>assets/front/img/gallery/<?= $a_Row->a_image;?>" alt="">
                                        </div>
    ...
    function readURL(input) {
        ...
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) {
                $('#story-pic').attr('src', e.target.result);
            }
