        ...
        <div class="right_col" role="main">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Design <small> Contact Us </small></h2>

                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                            <br />
                            <form id="story-form" method="post" action="<?php echo base_url();?>admin/a_contact_update" data-toggle="validator"  class="form-horizontal form-label-left" enctype="multipart/form-data">

                                <?php foreach ($con_Data as $c_Row){  ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7 col-sm-7 col-xs-12">
                                            <input required="required"  type="text" id="c_address" name="c_address"  class="form-control col-md-7 col-xs-12" value="<?php echo $c_Row->c_address; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7 col-sm-7 col-xs-12">
                                            <input required="required"  type="text" id="c_number" name="c_number"  class="form-control col-md-7 col-xs-12" value="<?php echo $c_Row->c_number; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7 col-sm-7 col-xs-12">
                                            <input required="required"  type="email" id="c_emailadd" name="c_emailadd"  class="form-control col-md-7 col-xs-12" value="<?php echo $c_Row->c_emailadd; ?>">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Weekdays :
                                        </label>
                                        <div class="col-md-7 col-sm-7 col-xs-12">
                                            <input required="required"  type="text" id="c_workingweekdays" name="c_workingweekdays"  class="form-control col-md-7 col-xs-12" value="<?php echo $c_Row->c_workingweekdays; ?>">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Weekennds :
                                        </label>
                                        <div class="col-md-7 col-sm-7 col-xs-12">
                                            <input required="required"  type="text" id="c_workingweekends" name="c_workingweekends"  class="form-control col-md-7 col-xs-12" value="<?php echo $c_Row->c_workingweekends; ?>">
                                        </div>
                                    </div>
