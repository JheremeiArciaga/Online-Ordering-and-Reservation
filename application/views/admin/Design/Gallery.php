        ...
        <div class="right_col" role="main">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Design <small> Gallery Album </small></h2>
                        ...
                        <div class="x_content">
                            ...
                            <table id="datatable" class="table table-striped table-bordered table-hover">
                                ...
                                <?php
                                if($g_Data){
                                    foreach ($g_Data as $rs) {
                                        ?>
                                        <tr>
                                            <td><?php echo sprintf("%05d",$rs->g_no);?></td>
                                            <td><?php echo $rs->g_title;?></td>
                                            <th>
                                                <a href="" class="load_modal_details" data-toggle="modal" data-target=".edit-carousel<?php echo $rs->g_no;?>"><i class="fa fa-pencil"></i> edit</a>
                                                |
                                                <a href="Javascript:Delete_Carousel(<?php echo $rs->g_no;?>)"><i class="fa fa-trash-o"></i> remove</a>
                            ...
                            <form method="post" id="frm_validation" action="<?php echo base_url();?>admin/j_gallery_add" data-toggle="validator" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                        <input type="text" id="g_title" name="g_title" required="required" class="form-control col-md-7 col-xs-12" value="">
                                    </div>
                                </div>
...
<?php foreach ($g_Data as $c_Rows){ ?>

    <div class="modal fade edit-carousel<?php echo $c_Rows->g_no;?>"  role="dialog" aria-labelledby="myLargeModalLabel">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content" id="load_modal_fields_large">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br />
                                <form method="post" id="frm_validation" action="<?php echo base_url();?>admin/j_gallery_edit" data-toggle="validator" class="form-horizontal form-label-left" enctype="multipart/form-data">

                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Identification No :
                                        </label>
                                        <div class="col-md-7 col-sm-7 col-xs-12">
                                            <input type="text" readonly="readonly" id="c_ID" name="c_ID" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $c_Rows->g_no;?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7 col-sm-7 col-xs-12">
                                            <input type="text" id="g_title" name="g_title" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $c_Rows->g_title;?>">
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    function Delete_Carousel(cid)
    {
        ...
        {
            location.href = "<?php echo base_url();?>admin/j_gallery_delete/"+cid;
        }
    }
