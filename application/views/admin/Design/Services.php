        ...
        <div class="right_col" role="main">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Design <small> Services </small></h2>
                        ...
                        <div class="x_content">
                            ...
                            <table id="datatable" class="table table-striped table-bordered table-hover">
                                ...
                                <?php
                                if($c_Data){
                                    foreach ($c_Data as $rs) {
                                        ?>
                                        <tr>
                                            <td><?php echo sprintf("%05d",$rs->rec_no);?></td>
                                            <td><?php echo $rs->s_title;?></td>
                                            <td><?php echo $rs->s_desc;?></td>
                                            <td><?php echo $rs->s_image;?></td>
                                            <th>
                                                <a href="" class="load_modal_details" data-toggle="modal" data-target=".edit-carousel<?php echo $rs->rec_no;?>"><i class="fa fa-pencil"></i> edit</a>
                                                |
                                                <a href="Javascript:Delete_Carousel(<?php echo $rs->rec_no;?>)"><i class="fa fa-trash-o"></i> remove</a>
        ...
        <div class="modal-content" id="load_modal_fields_large">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Services <small>Create Record</small></h2>
                            <ul class="nav navbar-right panel_toolbox">
                        ...
                        <div class="x_content">
                            <br />
                            <form method="post" id="frm_validation" action="<?php echo base_url();?>admin/h_services_add" data-toggle="validator" class="form-horizontal form-label-left" enctype="multipart/form-data">

                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Title :
                                    </label>
                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                        <input type="text" id="s_title" name="s_title" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                        <input type="text" id="s_desc" name="s_desc" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
...
<?php foreach ($c_Data as $c_Rows){ ?>

    <div class="modal fade edit-carousel<?php echo $c_Rows->rec_no;?>"  role="dialog" aria-labelledby="myLargeModalLabel">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content" id="load_modal_fields_large">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Services <small>Modify Record</small></h2>
                                <ul class="nav navbar-right panel_toolbox">
                            ...
                            <div class="x_content">
                                <br />
                                <form method="post" id="frm_validation" action="<?php echo base_url();?>admin/h_services_edit" data-toggle="validator" class="form-horizontal form-label-left" enctype="multipart/form-data">

                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Identification No :
                                        </label>
                                        <div class="col-md-7 col-sm-7 col-xs-12">
                                            <input type="text" readonly="readonly" id="c_ID" name="c_ID" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $c_Rows->rec_no;?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7 col-sm-7 col-xs-12">
                                            <input type="text" id="s_title" name="s_title" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $c_Rows->s_title;?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7 col-sm-7 col-xs-12">
                                            <input type="text" id="s_desc" name="s_desc" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $c_Rows->s_desc;?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7 col-sm-7 col-xs-12">
                                            <input type="file" class="form-control" accept="image/*" name="Filename" id="file_e1_<?php echo $c_Rows->rec_no;?>" onchange="return fileValidation_edit1(<?php echo $c_Rows->rec_no;?>)"/>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    {
        if (confirm("Delete Services Id : "+cid+"?"))
        {
            location.href = "<?php echo base_url();?>admin/h_services_delete/"+cid;
        }
    }
