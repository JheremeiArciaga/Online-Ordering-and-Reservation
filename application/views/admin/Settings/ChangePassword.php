            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br />
                            <form id="story-form" method="post" action="<?php echo base_url();?>admin/update_password" data-toggle="validator"  class="form-horizontal form-label-left" enctype="multipart/form-data">

                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Old Password :
                                    </label>
                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                        <input type="password" id="Old_p" name="Old_p" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                        <input type="password" id="New_p" name="New_p" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
