        ...
        <div class="right_col" role="main">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Menu <small> Food Item </small></h2>
                        ...
                        <div class="x_content">
                            ...
                            <table id="datatable" class="table table-striped table-bordered table-hover">
                                ...
                                <?php
                                if($jmi_Data){
                                    foreach ($jmi_Data as $rs) {
                                        ?>
                                        <tr>
                                            <td><?php echo sprintf("%05d",$rs->i_no);?></td>
                                            <td><?php echo $rs->i_category;?></td>
                                            <td><?php echo $rs->i_name;?></td>
                                            <td><?php echo $rs->i_description;?></td>
                                            <td><?php echo $rs->i_price;?></td>
                                            <td><?php if($rs->i_best == 1) { echo 'True'; } else { echo 'False'; }?></td>
                                            <td><?php echo $rs->i_image;?></td>
                                            <th>
                                                <a href="" class="load_modal_details" data-toggle="modal" data-target=".edit-carousel<?php echo $rs->i_no;?>"><i class="fa fa-pencil"></i> edit</a>
                                                |
                                                <a href="Javascript:Delete_Carousel(<?php echo $rs->i_no;?>)"><i class="fa fa-trash-o"></i> remove</a>
        ...
        <div class="modal-content" id="load_modal_fields_large">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Food Item <small>Create Record</small></h2>
                            <ul class="nav navbar-right panel_toolbox">
                        ...
                        <div class="x_content">
                            <br />
                            <form method="post" id="frm_validation" action="<?php echo base_url();?>admin/j_menu_item_add" data-toggle="validator" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                        <select class="form-control" name="i_category">
                                            ...
                                            <?php foreach ($jm_Data as $jmrow) {  ?>

                                                <option><?php echo $jmrow->m_name; ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                        <input type="text" id="i_name" name="i_name" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                        <input type="text" id="i_description" name="i_description" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                        <input type="text" id="i_price" name="i_price" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Featured :
                                    </label>
                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                        <select class="form-control" name="i_best">
                                            <option>True</option>
                                            <option>False</option>
                                        </select>
                                    </div>
...
<?php foreach ($jmi_Data as $c_Rows){ ?>

    <div class="modal fade edit-carousel<?php echo $c_Rows->i_no;?>"  role="dialog" aria-labelledby="myLargeModalLabel">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content" id="load_modal_fields_large">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Food Item <small>Modify Record</small></h2>
                                <ul class="nav navbar-right panel_toolbox">
                            ...
                            <div class="x_content">
                                <br />
                                <form method="post" id="frm_validation" action="<?php echo base_url();?>admin/j_menu_item_edit" data-toggle="validator" class="form-horizontal form-label-left" enctype="multipart/form-data">

                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Identification No :
                                        </label>
                                        <div class="col-md-7 col-sm-7 col-xs-12">
                                            <input type="text" readonly="readonly" id="c_ID" name="c_ID" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $c_Rows->i_no;?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7 col-sm-7 col-xs-12">
                                            <select class="form-control" name="i_category">
                                                <option selected hidden><?php echo $c_Rows->i_category;?></option>
                                                <?php foreach ($jm_Data as $jmrow) {  ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7 col-sm-7 col-xs-12">
                                            <input type="text" id="i_name" name="i_name" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $c_Rows->i_name;?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7 col-sm-7 col-xs-12">
                                            <input type="text" id="i_description" name="i_description" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $c_Rows->i_description;?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7 col-sm-7 col-xs-12">
                                            <input type="text" id="i_price" name="i_price" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $c_Rows->i_price;?>">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Sale :
                                        </label>
                                        <div class="col-md-7 col-sm-7 col-xs-12">
                                            <select class="form-control" name="i_best">
                                                <option selected hidden><?php if($c_Rows->i_best == 1) { echo 'True'; } else { echo 'False'; }?></option>
                                                <option>True</option>
                                                <option>False</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7 col-sm-7 col-xs-12">
                                            <input type="file" class="form-control" accept="image/*" name="Filename" id="file_e1_<?php echo $c_Rows->i_no;?>" onchange="return fileValidation_edit1(<?php echo $c_Rows->i_no;?>)"/>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    {
        if (confirm("Delete Food Item Id : "+cid+"?"))
        {
            location.href = "<?php echo base_url();?>admin/j_menu_item_delete/"+cid;
        }
    }
