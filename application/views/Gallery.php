...
<body>
   ...
   <div class="banner-area breadcrumb-area padding-top-120 padding-bottom-90">
    ...
    <div class="food-area-wrapper main-gallery">
        <div class="pshapes">
            <span class="ps-1"><img src="<?php echo base_url(); ?>assets/img/32.png" alt=""></span>
            <span class="ps-2"><img src="<?php echo base_url(); ?>assets/img/shapes/12.png" alt=""></span>
            <span class="ps3"><img src="<?php echo base_url(); ?>assets/img/shapes/13.png" alt=""></span>
            <span class="ps-4"><img src="<?php echo base_url(); ?>assets/img/shapes/14.png" alt=""></span>
            <span class="ps-5"><img src="<?php echo base_url(); ?>assets/img/img/6.png" alt=""></span>
            <span class="ps-6"><img src="<?php echo base_url(); ?>assets/img/shapes/16.png" alt=""></span>
            <span class="ps-7"><img src="<?php echo base_url(); ?>assets/img/img/6.png" alt=""></span>
        </div>
        ...
        <div class="row margin-bottom-60">
                    ...
                    <div class="gallery-btn button-group filter-button-group">
                        <button class="active" data-filter="*">all items</button>
                         <?php foreach ($galleryData as $galleryRow) { ?>
                            <button data-filter=".<?php echo $galleryRow->g_title; ?>"><?php echo $galleryRow->g_title; ?></button>
                        <?php } ?>
                    </div>
                </div>
            </div>
            ...
            <div class="row gallery-wrapper grid">
                ...
                <?php foreach ($imageData as $imageRow) { ?>

                   <div class="col-lg-4 col-md-6 col-12 <?php echo $imageRow->gi_category;?> grid-item">
                        <div class="gallery-img">
                            <img class="img-responsive" src="<?php echo base_url(); ?>assets/img/<?php echo $imageRow->gi_image;?>" alt="">
                        </div>
                    </div>
